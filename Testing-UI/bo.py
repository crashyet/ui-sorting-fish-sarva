...
class App(ctk.CTk):
    ...
    def create_info_widgets(self):
        ...
        info_descs = ["Jumlah Pcs Tersortir", "Jumlah Kg Tersortir", "Jumlah Pcs / jam", "Jumlah Kg / jam"]
    ...
    def start_system(self):
        if self.system_running:
            self.log_activity("Sistem sudah berjalan.")
            return
    ...
    def load_json_data(self):
        ...
        if os.path.exists(json_path):
            ...
            self.json_data = {
                ...
                "trash": "13.3", # <<< [FIX] Baris ini yang menyebabkan error, import tambahan telah dihapus.
    ...
    def update_all_sections(self):
        ...
        box_data = self.json_data.get("box_manager", [["0","0","0"]]*3)
        for r in range(3):
            for c in range(3):
                value = box_data[r][c]
    ...
    def open_settings_window(self):
        ...
        # ... (sisa kode untuk jendela settings tidak diubah)
