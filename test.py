    ...
    def update_webcam(self):
        ...
        if ret:
            ...
            if label_width > 1 and label_height > 1:
                ...
                frame_height_orig, frame_width_orig, _ = frame_rgb.shape
                video_aspect_ratio = frame_width_orig / frame_height_orig
                ...
                # Buat CTkImage
                ctk_img = ctk.CTkImage(light_image=img_resized, size=(new_width, new_height))
